...
?>
                    ...
                    <div class="container my-5 color_white">
                        ...
                        <div class="row text-center p-1">
                            ...
                            <a title="Modifier" href="../modifier/index.php?id=<?php echo $produit['id']; ?>" class="color_black col-sm size_s bg_grey m-0 p-3">Modifier</a>
                            <a title="Supprimer" href="?delete=<?php echo $produit["id"]; ?>" class="color_black col-sm size_s bg_grey2 m-0 p-3">Supprimer</a>
                        </div>
